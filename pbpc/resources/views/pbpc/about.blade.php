...
<div id="wrapper">
    ...
    <div id="main">
        ...
        <article class="post">
            <header>
                ...
                <div class="meta">
                    ...
                    <a href="#" class="author"><span class="name">Davy Swai</span><img src="{{asset('images/girls.jpg')}}" alt="" /></a>
                </div>
            </header>
            <a href="pbpc/simple_header" class="image featured"><img src="{{asset('images/girls.jpg')}}" alt="" /></a>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos distinctio laboriosam non numquam perferendis! Accusamus commodi delectus omnis quaerat quas quod repellat sed sit veritatis? Aperiam autem iste magni nobis?</p>
            <footer>
                <ul class="actions">
        ...
        <article class="post">
            <header>
                <div class="title">
                    <h2><a href="{{url('pbpc/simple_section_two')}}">A pride of mswiswi</a></h2>
                    <p></p>
                </div>
                <div class="meta">
            ...
            <a href="{{url('pbpc/simple_section_two')}}" class="image featured"><img src="{{asset('images/children.jpg')}}" alt="" /></a>
        ...
        <article class="post">
            <header>
                ...
                <div class="meta">
                    ...
                    <a href="{{url('simple_section_three')}}" class="author"><span class="name">davy swai</span><img src="{{asset('images/kingfisher.jpg')}}" alt="" /></a>
                </div>
            </header>
            ...
            <article class="post">
                <header>
                    ...
                    <div class="meta">
                        ...
                        <a href="#" class="author"><span class="name">davy swai</span><img src="images/avatar.jpg" alt="" /></a>
                    </div>
                </header>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
    ...
    <section id="sidebar">
            ...
            <div class="mini-posts">
                ...
                <article class="mini-post">
                    <header>
                        ...
                        <a href="{{url('pbpc/courage')}}" class="author"><img src="{{asset('images/obstacle.jpg')}}" alt="" /></a>
                    </header>
                ...
                <article class="mini-post">
                    <header>
                        ...
                        <a href="{{url('pbpc/noise')}}" class="author"><img src="{{asset('images/bell.jpg')}}" alt="" /></a>
                    </header>
                ...
                <article class="mini-post">
                    <header>
                        ...
                        <a href="{{url('pbpc/book')}}" class="author"><img src="{{asset('images/book.jpg')}}" alt="" /></a>
                    </header>
        ...
        <section>
            <ul class="posts">
                <li>
                    <article>
                        <header>
                            <h3><a href="single.html">knowing where your going seems not enough now days</a></h3>
                ...
                <li>
                    <article>
                        <header>
                            <h3><a href="single.html">life without green</a></h3>
                ...
                <li>
                    <article>
                        <header>
                            <h3><a href="single.html">Education is mis-interpreted now days</a></h3>
                ...
                <li>
                    <article>
                        <header>
                            <h3><a href="single.html">the magic of doing what you love</a></h3>
                ...
                <li>
                    <article>
                        <header>
                            <h3><a href="single.html">what is golden circle?</a></h3>
        ...
        <section class="blurb">
            <h2>About</h2>
            <p>Mauris neque quam, fermentum ut nisl vitae, convallis maximus nisl. Sed mattis nunc id lorem euismod amet placerat. Vivamus porttitor magna enim, ac accumsan tortor cursus at phasellus sed ultricies. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corporis dolor esse minus odio officia praesentium qui vero voluptate? Dolor minus modi omnis recusandae repudiandae! Consectetur ipsa ipsum quidem quos unde. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias consequatur cumque dicta dolores eius eligendi, expedita impedit ipsum iste libero nemo, provident recusandae rem repellat repellendus saepe sapiente sed veritatis.</p>
