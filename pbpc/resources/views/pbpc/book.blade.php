...
<div id="wrapper">
    ...
    <div id="main">
        ...
        <article class="post">
            <header>
                <div class="title">
                    <h2><a href="{{url('pbpc/book')}}">enlightenment</a></h2>
                    <p></p>
                </div>
                <div class="meta">
                    <time class="published" datetime="2015-10-25">October 25, 2015</time>
                    <a href="{{url('pbpc/book')}}" class="author"><span class="name">davy swai</span><img src="{{asset('images/book1.jpg')}}" alt="" /></a>
                </div>
            </header>
            <span class="image featured"><img src="{{asset('images/book1.jpg')}}" alt="" /></span>
